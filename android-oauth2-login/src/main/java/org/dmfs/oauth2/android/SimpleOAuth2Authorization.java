 ...
 * @author Marten Gajda
 */
public final class SimpleOAuth2Authorization implements OAuth2Authorization
{
    private final int mFragmentHostId;
    private final Bundle mArguments;


    public SimpleOAuth2Authorization(OAuth2ClientFactory oAuth2CientFactory, OAuth2InteractiveGrant interactiveGrant, int fragmentHostId)
    {
    ...
    private SimpleOAuth2Authorization(Bundle arguments, int fragmentHostId)
    {
    ...
    public OAuth2Authorization withCage(Cage<OAuth2InteractiveGrant.OAuth2GrantState> resultStatePigeon)
    {
        ...
        return new SimpleOAuth2Authorization(arguments, mFragmentHostId);
    }
    ...
    public void start(@NonNull FragmentActivity fragmentActivity)
    {
        ...
        fragmentActivity.getSupportFragmentManager().beginTransaction().add(mFragmentHostId, interactiveGrantFragment).commit();
    }
}
